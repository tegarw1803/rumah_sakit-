...
import { Menu, X, Phone, Mail, MapPin, Facebook, Twitter, Instagram, Youtube, Clock, Calendar, User, Stethoscope, Heart, Syringe, Ambulance, PhoneCall, Moon, Sun } from 'lucide-react'
...
const schedulesData = [
  { doctorId: 1, dayOfWeek: 'Senin', startTime: '08:00', endTime: '12:00', poli: 'Penyakit Dalam' },
  { doctorId: 1, dayOfWeek: 'Rabu', startTime: '14:00', endTime: '17:00', poli: 'Penyakit Dalam' },
  { doctorId: 2, dayOfWeek: 'Selasa', startTime: '09:00', endTime: '13:00', poli: 'Anak' },
  { doctorId: 2, dayOfWeek: 'Kamis', startTime: '08:00', endTime: '12:00', poli: 'Anak' },
  { doctorId: 3, dayOfWeek: 'Senin', startTime: '10:00', endTime: '14:00', poli: 'Bedah' },
  { doctorId: 4, dayOfWeek: 'Jumat', startTime: '08:00', endTime: '12:00', poli: 'Kandungan' },
]
...
export default function HospitalLandingPage() {
  ...
  const filteredDoctors = doctorsData.filter((doctor) => {
    ...
    if (selectedDay !== 'all') {
      const hasSchedule = schedulesData.some(
        (s) => s.doctorId === doctor.id && s.dayOfWeek === selectedDay
      )
  ...
  const openAppointmentDialog = (doctor: typeof doctorsData[0]) => {
        ...
        <div className="container mx-auto px-4">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-bold text-foreground">RS Sehat Selalu</h1>
                <p className="text-xs text-muted-foreground">Layanan Kesehatan Terpercaya</p>
              </div>
            </div>
        ...
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-cyan-600 to-teal-600 dark:from-cyan-400 dark:to-teal-400 bg-clip-text text-transparent">
              Selamat Datang di RS Sehat Selalu
            </h1>
            <p className="text-lg md:text-xl text-muted-foreground mb-8">
              Kami menyediakan layanan kesehatan profesional dengan tim dokter berpengalaman dan fasilitas modern untuk kesehatan Anda dan keluarga
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <Card className="border-2 bg-gradient-to-br from-cyan-50/50 to-teal-50/50 dark:from-cyan-950/20 dark:to-teal-950/20">
              <CardHeader>
                <CardTitle className="text-2xl">RS Sehat Selalu</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-muted-foreground leading-relaxed">
                  RS Sehat Selalu adalah rumah sakit modern yang berdedikasi untuk memberikan layanan kesehatan terbaik bagi masyarakat. Dengan peralatan medis terkini dan tim tenaga kesehatan profesional, kami siap melayani Anda dengan sepenuh hati.
                </p>
                <p className="text-muted-foreground leading-relaxed">
                  Didirikan pada tahun 2010, RS Sehat Selalu telah melayani ribuan pasien dengan berbagai kebutuhan medis. Kami berkomitmen untuk terus meningkatkan kualitas layanan dan memperluas jangkauan pelayanan kesehatan kepada masyarakat.
                </p>
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 pt-4">
                  <div className="text-center p-4 bg-background rounded-lg border-2 hover:border-cyan-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/20">
                  ...
                  <div className="text-center p-4 bg-background rounded-lg border-2 hover:border-cyan-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/20">
                    <div className="text-3xl font-bold text-cyan-600 dark:text-cyan-400">10K+</div>
        ...
        <div className="container mx-auto px-4">
              ...
              <div className="flex-1 min-w-[200px]">
                ...
                <Select value={selectedSpecialty} onValueChange={setSelectedSpecialty}>
                  ...
                  <SelectContent>
                    ...
                    {Array.from(new Set(doctorsData.map((d) => d.specialty))).map((spec) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredDoctors.map((doctor) => {
              const doctorSchedules = schedulesData.filter((s) => s.doctorId === doctor.id)
              return (
                <Card
                  key={doctor.id}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <Card className="border-2 hover:border-cyan-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/20 text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-2">IGD: (021) 1234-5678</p>
                <p className="text-muted-foreground">Umum: (021) 1234-5679</p>
              </CardContent>
            </Card>
            <Card className="border-2 hover:border-cyan-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/20 text-center">
              <CardHeader>
            ...
            <Card className="border-2 hover:border-cyan-400 dark:hover:border-cyan-500 transition-all duration-300 hover:shadow-lg hover:shadow-cyan-400/20 text-center">
              ...
              <CardContent>
                <p className="text-muted-foreground mb-1">IGD: 24 Jam</p>
                <p className="text-muted-foreground mb-1">Poli: 08:00 - 20:00</p>
                <p className="text-muted-foreground">Minggu: 08:00 - 14:00</p>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      <footer className="bg-background border-t mt-auto">
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h3 className="font-bold">RS Sehat Selalu</h3>
                  <p className="text-xs text-muted-foreground">Layanan Kesehatan Terpercaya</p>
                </div>
              </div>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <Button variant="ghost" size="icon" className="rounded-full hover:bg-cyan-50 hover:text-cyan-600 dark:hover:bg-cyan-950 dark:hover:text-cyan-400 transition-all duration-300">
          ...
          <div className="border-t mt-8 pt-8 text-center text-sm text-muted-foreground">
            <p>© 2024 RS Sehat Selalu. All rights reserved.</p>
